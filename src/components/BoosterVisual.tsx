...
export function BoosterVisual({ type, className = '' }: { type: BoosterType; className?: string }) {
  ...
  if (type === 'cross') {
    return <div className={`${common} border-cyan-100/80 bg-cyan-500/25`} title="Cross charge — clears its row and column">
  ...
  if (type === 'bomb') {
    return <div className={`${common} border-orange-100/80 bg-orange-500/30`} title="Bomb — clears cells within radius 2">
  ...
  return <div className={`${common} border-fuchsia-100/85 bg-violet-500/25`} title="Chroma rune — clears all warriors of touched colors">
